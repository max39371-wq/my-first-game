...
REQUIRED_COUNTRIES = {
    "Armenia", "Azerbaijan", "Bangladesh", "China", "Cyprus", "Georgia", "India", "Indonesia",
    "Iran", "Iraq", "Israel", "Kazakhstan", "Kyrgyzstan", "Laos", "Lebanon", "Maldives",
    "Mongolia", "Myanmar", "Nepal", "North Korea", "Pakistan", "Philippines", "Singapore",
    "South Korea", "Sri Lanka", "Syria", "Tajikistan", "Timor-Leste", "Turkey", "Turkmenistan",
    "Uzbekistan", "Vietnam", "Yemen"
}

ALLOWED_SYS = {"presidential", "parliamentary", "semi_presidential", "council", "one_party", "military", "provisional", "theocratic"}
...
def test_validation():
    filepath = "data/republics_asia.json"
    ...
    for idx, card in enumerate(data):
        ...
        # en
        en_name = card.get("en")
        assert en_name in REQUIRED_COUNTRIES, f"Country '{en_name}' is not in the list of allowed/required Asian republics or is misspelled."
    ...
    # Verify all 33 countries are covered
