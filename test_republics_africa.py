...
REQUIRED_COUNTRIES = {
    ...
    "Libya", "Madagascar", "Malawi", "Mali", "Mauritania", "Mauritius", "Mozambique", "Namibia",
...
def test_validation():
    filepath = "data/republics_africa.json"
    ...
    for idx, card in enumerate(data):
        ...
        # en
        en_name = card.get("en")
        assert en_name in REQUIRED_COUNTRIES, f"Country '{en_name}' is not in the list of allowed/required African republics or is misspelled."
    ...
    # Verify all 51 countries are covered
