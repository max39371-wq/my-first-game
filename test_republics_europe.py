...
REQUIRED_COUNTRIES = {
    "Albania", "Austria", "Belarus", "Bosnia and Herzegovina", "Bulgaria", "Croatia", "Czechia", "Estonia",
    "Finland", "France", "Germany", "Greece", "Hungary", "Iceland", "Ireland", "Italy", "Latvia",
    "Lithuania", "Malta", "Moldova", "Montenegro", "North Macedonia", "Poland", "Portugal", "Romania",
    "Russia", "San Marino", "Serbia", "Slovakia", "Slovenia", "Switzerland", "Ukraine"
}
...
def test_validation():
    filepath = "data/republics_europe.json"
    ...
    for idx, card in enumerate(data):
        ...
        # en
        en_name = card.get("en")
        assert en_name in REQUIRED_COUNTRIES, f"Country '{en_name}' is not in the list of allowed/required European republics or is misspelled."
